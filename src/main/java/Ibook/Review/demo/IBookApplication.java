...
//
        ...
        list2.add(cat2);list2.add(cat1);list2.add(cat2);
        ...
        Author author2 = new Author(4, "La Hoài Trinh", now, Status.STATUS_AUTHOR.MALE, list3);
...
//        listAuthor1.add(author2);listAuthor1.add(author3);listAuthor1.add(author4);
        ...
        User user = new User(1, "admin", passwordEncoder.encode("123"), null, "ROLE_ADMIN");
        User user1 = new User(2, "minhchuan", passwordEncoder.encode("123"), listBook1, "ROLE_AUTHOR");
        User user2 = new User(3, "letuantu", passwordEncoder.encode("123"), listBook2, "ROLE_AUTHOR");
        User user3 = new User(4, "ngoctrinh", passwordEncoder.encode("123"), listBook4, "ROLE_AUTHOR");
        User user4 = new User(5, "phantuan", passwordEncoder.encode("123"), listBook3, "ROLE_AUTHOR");
